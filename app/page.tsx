      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          <p className="text-gray-200 hidden md:block">
            As a seasoned Full-Stack Developer, I specialize in leveraging the
            MERN (MongoDB, Express.js, React.js, Node.js) stack to build
            scalable and robust web applications. With proficiency in additional
            technologies such as NestJS, Redux, Docker, and Azure, I bring a
